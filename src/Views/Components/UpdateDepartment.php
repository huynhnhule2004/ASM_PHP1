                ...
                <div class="container-fluid px-4 ">
                    <div class="card mb-4 mt-5">
                        <form class="form-horizontal" action="" method="GET">
                            <h3 align='center' style="font-weight: bold; color:#b81b1b">ADD DEPARTMENT</h3>
                            <table>
                                <tr>
                                    <td class="col-3">
                                        <div class="input-group w-70 mb-3 mt-2">
                                            ...
                                            <input name="name" class="form-control me-2 " aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" id="link" readonly type=text>
                                        </div>
                                    </td>
                                    <td class="col-3">
                                        <div class="input-group w-70 mb-3 mt-2">
                                            <span class="input-group-text ms-2 w-25" id="inputGroup-sizing-default">Description</span>
