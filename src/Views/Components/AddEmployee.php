                ...
                <div class="container-fluid px-4 ">
                    <div class="card mb-4 mt-5">
                        <form class="form-horizontal" action="" method="GET">
                            <h3 align='center' style="font-weight: bold; color:#b81b1b">ADD EMPLOYEE</h3>
                            <table>
                                <tr>
                                    <td class="col-3">
                                    ...
                                    <td class="col-3">
                                        <div class="input-group w-70 mb-3 mt-2">
                                            <span class="input-group-text ms-2 w-30" id="inputGroup-sizing-default">Last Name</span>
                                    ...
                                    <td class="col-3">
                                        <div class="input-group w-70 mb-3 mt-2">
                                            ...
                                            <input name="date_of_birth" type="date"  class="form-control me-2" aria-label="sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                    </td>
                                    <td class="col-3">
                                        <div class="input-group w-70 mb-3 mt-2">
                                            <span class="input-group-text ms-2 w-30" id="inputGroup-sizing-default">Gender</span>
                                            <input name="gender" type="text"  class="form-control me-2" aria-label="sizing example input" aria-describedby="inputGroup-sizing-default">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
